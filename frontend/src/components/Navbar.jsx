...
import { Shield, LayoutDashboard, UploadCloud, FileText, User, LogOut, Activity } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3 cursor-pointer" onClick={() => setActiveTab('dashboard')}>
            <div className="p-2 bg-blue-600/20 border border-blue-500/40 rounded-lg text-blue-400 cyber-glow-blue">
          ...
          <div className="flex items-center space-x-3">
            <div className="hidden lg:flex items-center text-xs space-x-2 px-3 py-1.5 bg-gray-800/80 rounded-full border border-gray-700">
              ...
              <span className="text-gray-300 font-medium">{currentUser?.username || 'Analyst'}</span>
